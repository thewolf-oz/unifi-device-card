/* UniFi Device Card 0.0.0-dev.0b7f3e7 */
  ...
  _renderPanelAndDetail(title) {
    ...
    if (selected) {
      ...
      detail = `
        ...
        const portEnabled = isOn(this._hass, selected.port_switch_entity);
        return `<button class="action-btn secondary" data-action="toggle-port" data-entity="${selected.port_switch_entity}">
                  ${portEnabled ? "\u23F9 Port deaktivieren" : "\u25B6 Port aktivieren"}
                </button>`;
      })() : ""}
...
var VERSION2 = "0.0.0-dev.0b7f3e7";
